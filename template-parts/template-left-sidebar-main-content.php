...
?>
<?php get_header() ?>
<div style="position: relative; display: flex;padding-bottom: 50px; flex-direction: column; width: 100%; padding-bottom: 150px; font-size: 22px; line-height: 30px; background-image: url('<?php echo get_theme_file_uri("/images/basic-hero.svg"); ?>'">
    ...
    <div style="display:flex; flex-direction: row; justify-content: space-between;  ">
        ...
        <main class="template-left-sidebar-main-content">
            <?php the_content() ?>
        </main>
    </div>
</div>
